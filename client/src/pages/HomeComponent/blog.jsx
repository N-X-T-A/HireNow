    ...
    <div className="w-full bg-white flex flex-col  gap-5 mt-[100px] items-center justify-items-center justify-center">
      ...
      <div className="w-full flex flex-row gap-2 items-center justify-center">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, delay: 0.3 }}
          viewport={{ once: true, amount: 0.3 }}
          className="flex-1 flex flex-col gap-3 max-h-[787px] overflow-y-auto text-justify"
          style={{
            scrollbarWidth: "none",
        ...
        >
          ...
          >
            <img
              className="w-full max-w-[300px] rounded-[30px]"
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="!mb-0 text-[12px] font-[400] text-gray-400">
